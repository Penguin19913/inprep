...
import { assets, dummyTestimonial } from '../../assets/assests.js'

const TestimonialsSection = () => {
  return (
    <div className='pb-14 px-8 md:px-0'>
      <h2 className='text-3x1 font-medium text-gray-800'>Testimonials</h2>
      ...
      <div className='grid gridTemplateColumns gap-8 mt-14'>
