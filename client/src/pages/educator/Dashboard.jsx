...
import { assets, dummyDashboardData } from '../../assets/assests'
    ...
    <div className='min-h-screen flex flex-col items-start justify-between gap-8 md:p-8 md:pb-0 p-4 pt-8 pb-0'>
      <div className='space-y-5'>
        ...
        <div>
          ...
          <div className='flex flex-col items-center max-w-4xl w-full overflow-hidden rounded-mb bg-white broder border-gray-500/20'>
