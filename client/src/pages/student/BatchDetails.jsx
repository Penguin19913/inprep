...
const BatchDetails = () => {
  ...
  return batchData && enrolledStudents ? (
    <>
      <div className="flex md:flex-row flex-col-reverse xl:gap-50 gap-10 relative items-start md:justify-center items-center md:gap-30 md:px-36 px-8 md:pt-30 w-screen pt-10 text-left">
